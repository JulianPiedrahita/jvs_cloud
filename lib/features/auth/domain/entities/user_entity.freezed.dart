...
class _$UserEntityImpl extends _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, email: $email, firstName: $firstName, lastName: $lastName, avatarUrl: $avatarUrl, createdAt: $createdAt, lastLoginAt: $lastLoginAt, isEmailVerified: $isEmailVerified, isBiometricEnabled: $isBiometricEnabled, preferences: $preferences, favoriteContent: $favoriteContent)';
  }
...
abstract class _UserEntity extends UserEntity {
  const factory _UserEntity(
      ...
      final List<String> favoriteContent}) = _$UserEntityImpl;
